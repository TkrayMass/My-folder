...
def write_log(message: str) -> None:
    """Write a timestamped message to the monthly email log."""
...
def previous_completed_month() -> tuple[int, int]:
    """
    Return the year and month of the previous completed month.

    Example:
        Run in August 2026 -> July 2026
    """
...
def build_email_subject() -> str:
    """Build the subject using the actual report month."""
...
def expected_report_files() -> tuple[Path, Path]:
    """Build the expected Snapshot and Caseload filenames."""
...
def validate_reports(
    ...
    """Confirm that both expected monthly reports exist."""
...
def send_outlook_email(
    ...
    """Send the monthly notification through Classic Outlook."""
...
def main() -> None:
    """Validate both reports and send the monthly notification."""
